            ...
            <div class="title d-flex my-5">
                <h2>Product List</h2>
                 <div class="d-flex buttons">
                  <a class="btn btn-success" href="./add.php" role="button" name="add">Add</a>
                  <button class="btn btn-danger delete-btn" id="mass-delete" type="submit" name="mass-delete">MASS DELETE</button> 
                 </div>
